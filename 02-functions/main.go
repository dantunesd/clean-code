...
/** Even if this function has less than 25 lines, an appropriated function name, some significant variables name, it still difficult to read/understand this function.
